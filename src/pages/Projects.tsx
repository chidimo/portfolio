            ...
            <div className="tech_projects">
              <div className="fs_projects card">
                ...
                <p className="app_description">
                  ...
                  financial inclusion as a way to alleviate poverty and empower
                  low income earners.
                  <br />
                  <br />
                  Currently, on the frontend app, only the authentication
                  endpoints have been wired to the backend.
                </p>
                <p className="stack">
                  Stack: <code>Express</code>, <code>HTML5</code>,{' '}
                  <code>CSS3</code>, <code>JavaScript</code>
                </p>
                <div className="project_links">
                  ...
                  <a href="https://qcredit.herokuapp.com/api/v1/">
                    Backend App
                  </a>
                  <hr />
                  <a href="https://github.com/chidimo/Quick-Credit">
                    Github repo
                  </a>
                  <a href="https://qcredit.docs.apiary.io/">
                    API documentation
                  </a>
                </div>
              </div>
              <div className="django_projects card">
                <h4 className="app_name">
                  Ethodoxy (<code>Djangorestframework</code> +{' '}
                  <code>React</code>)
                </h4>
                <p className="app_description">
                  The name is a short form for Electronic Orthodoxy. The current
                  database features the <strong>Douay-Rheims</strong> version of
                  the bible and the <strong>Challoner</strong> commentary.
                  <br />
                  <br />
                ...
                <div className="project_links">
                  ...
                  <a href="https://ethodoxy.herokuapp.com/api/v1">
                    Backend App
                  </a>
                  <hr />
                  <a href="https://github.com/chidimo/ethodoxy-api">
                    Backend Repo
                  </a>
                  <a href="https://github.com/chidimo/Ethodoxy">
                    Frontend Repo
                  </a>
          ...
          <div id="react" className="tech">
            ...
            <div className="tech_projects">
              ...
              <div className="react_projects card">
                ...
                <p className="app_description">
                  A would you rather game I built as part of my{' '}
                  <code>React</code>
                  nanodegree program at Udacity. Game description is available
                  in the repo.
                </p>
                <p className="stack">
              ...
              <div className="react_projects card">
                ...
                <div className="project_links">
                  ...
                  <hr />
                  <a href="https://github.com/chidimo/Url-Shortener">
                    Github Repo
                  </a>
                </div>
              </div>
          ...
          <div id="django" className="tech">
            ...
            <div className="tech_projects">
              <div className="django_projects card">
                ...
                <p className="app_description">
                  The app is a place for sharing choral music sheets and midi
                  files.
                </p>
                <p className="stack">
                ...
                <div className="project_links">
                  <a href="https://github.com/chidimo/ChoralCentral">
                    Github Repo
                  </a>
              ...
              <div className="django_projects card">
                ...
                <p className="app_description">
                  Request YouTube and/or Google Drive access from within a
                  Django web app
                </p>
                <p className="stack">
            ...
            <div className="tech_projects">
              <div className="python_app card">
                ...
                <p className="app_description">
                  ...
                  is a sample output of the report it generates for a repo
                  status command.
                </p>
                <div className="project_links">
                  <a href="https://github.com/chidimo/python-git">
                    Github Repo
                  </a>
                </div>
              </div>
          ...
          <div id="ds" className="tech">
            ...
            <div className="tech_projects">
              ...
              <div className="ds_projects card">
                ...
                <p className="app_description">
                  Plotting temperature highs and lows for every calendar day of
                  the year in Abu Dhabi, UAE for the ten-year period, 20052014
                </p>
                <div className="project_links">
              ...
              <div className="ds_projects card">
                ...
                <p className="app_description">
                  Building a custom visualization from probabilistic data
                  generated through samples in matplotlib
                </p>
                <div className="project_links">
          ...
          <div id="gis" className="tech">
            ...
            <div className="tech_projects">
              <div className="gis_projects card">
                ...
                <p className="app_description">
                  The "yes" vote patterns in California Counties on Proposition
                  37 in 2012
                </p>
                <div className="project_links">
              ...
              <div className="gis_projects card">
                ...
                <p className="app_description">
                  Map of Hourly Average Ozone Concentrations around California
                  in 2010-2011
                </p>
                <div className="project_links">
